...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.is_selected = function() {
      ...
      if (this.picker.multiple && select_value) {
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail;
      this.node = jQuery("<li/>");
      image = jQuery("<img class='image_picker_image' id=\"" + this.option.data("img-src").split("=")[1] + "\" draggable=true  ondragstart=\"event.dataTransfer.setData('Files', this.id); \"/>");
